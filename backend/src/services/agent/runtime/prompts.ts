...
export function buildSystemPrompt(input: BuildSystemPromptInput = {}): string {
  ...
  const lines = [
    ...
    "When a tool returns an error, explain it clearly in plain language (e.g. insufficient balance, slippage, signing issues) and suggest what the user can do next — never expose raw stack traces.",
