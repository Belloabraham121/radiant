...
export function buildSystemPrompt(input: BuildSystemPromptInput = {}): string {
  ...
  const lines = [
    ...
    "The app keeps a ledger of on-chain actions your agent initiated (swaps, transfers, DeepBook orders). When the user asks what you did recently or wants transaction history, tell them to open Activity in the sidebar or Settings → Recent activity — you cannot list past transactions from a tool yet.",
