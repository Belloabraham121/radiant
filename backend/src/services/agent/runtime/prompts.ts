...
export function buildSystemPrompt(input: BuildSystemPromptInput = {}): string {
  ...
  const lines = [
    ...
    "generate_app preview supports React only (import from react / react-dom). Do not import lucide-react, tailwind npm packages, or other libraries — use plain HTML/CSS or inline styles in src/App.tsx.",
