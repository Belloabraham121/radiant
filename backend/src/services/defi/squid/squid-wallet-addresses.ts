...
export type SquidWalletAddressBook = Partial<Record<"sui" | "solana" | "ethereum", string>>;
...
/** Resolve source and destination agent wallet addresses for Squid quote/routes. */
