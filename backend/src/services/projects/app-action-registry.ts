...
export const APP_ACTION_REGISTRY: Record<OnchainActionName, AppActionDefinition> = {
  ...
  margin_stake: defineAction({
    name: "margin_stake",
    description: "Stake DEEP from a margin manager into a DeepBook pool for fee discounts.",
    protocol: "deepbook",
    default_chain_id: "sui",
    execute_action: "deepbook_margin_stake",
  }),
  margin_unstake: defineAction({
    name: "margin_unstake",
    description: "Unstake all active DEEP from a margin manager pool stake.",
    protocol: "deepbook",
    default_chain_id: "sui",
    execute_action: "deepbook_margin_unstake",
  }),
  margin_submit_proposal: defineAction({
    name: "margin_submit_proposal",
    description: "Submit a next-epoch fee proposal via a margin manager.",
    protocol: "deepbook",
    default_chain_id: "sui",
    execute_action: "deepbook_margin_submit_proposal",
  }),
  margin_vote: defineAction({
    name: "margin_vote",
    description: "Vote on a DeepBook pool governance proposal via a margin manager.",
    protocol: "deepbook",
    default_chain_id: "sui",
    execute_action: "deepbook_margin_vote",
  }),
  margin_claim_rebate: defineAction({
    name: "margin_claim_rebate",
    description: "Claim unclaimed trading rebates from a margin manager.",
    protocol: "deepbook",
    default_chain_id: "sui",
